...
{   
    ...
    ddmenuitem.style.top=getOffset(menu).top;
    ddmenuitem.style.left=.1*screen.width+10;
...
<div id="content">
	<div id="menu">
		<a href="?page=index">Objective</a>
		<a href="?page=listexp">List Of Experiments</a>
		<a href="#"
        onmouseover="mopen('m1',this)"
        onmouseout="mclosetime()">Experiments</a>

		<a href="?page=futurework">Future Work</a>
